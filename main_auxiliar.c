...
// Acende um LED aleatório (exceto pelo verde)
static void acende_led_aleatorio()
{
    int r = numero_aleatorio(0, 5);

    switch (r)
    {
    case 0:
        set_rgb_pwm(65535, 65535, 65535); // branco
        break;
    case 1:
        set_rgb_pwm(65535, 0, 0); // vermelho
        break;
    case 2:
        set_rgb_pwm(0, 0, 65535); // azul
        break;
    case 3: 
        set_rgb_pwm(65535, 65535, 0); // amarelo
        break;
    case 4:
        set_rgb_pwm(65535, 0, 65535); // magenta
        break;
    case 5:
        set_rgb_pwm(0, 65535, 65535); // ciano
        break;
    default:
        break;
    }
...
void tratar_mensagem(MensagemWiFi msg) {
    ...
    if (msg.tentativa == 0x9999) {
        if (msg.status == 0) {
            ...
            acende_led_aleatorio();  // Acende o LED com uma cor aleatória
        } else {
